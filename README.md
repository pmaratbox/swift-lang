...
Incremental lessons learning Swift.
...
- macOS: install Xcode, or the Command Line Tools via `xcode-select --install` (both include Swift)
- Linux / Windows: download a toolchain from [swift.org/install](https://www.swift.org/install/)
